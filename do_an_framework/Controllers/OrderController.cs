...
namespace do_an_framework.Controllers
{
    public class OrderController : Controller
    {
        ...
        /*public async Task<IActionResult> info(int id)
        {
            ...
            cmd = this.MySqlDatabase.Connection.CreateCommand() as MySqlCommand;
            cmd.CommandText = @"SELECT ma_san_pham, anh_san_pham, ten_san_pham, don_gia, ten_danh_muc from san_pham join danh_muc on san_pham.ma_danh_muc = danh_muc.ma_danh_muc";
